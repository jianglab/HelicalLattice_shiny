...
import src.helicon.helicon as helicon
...
def main(args):
    ...
    for option_name in args.all_options:
        ...
        if option_name == "minDuplicates" and param > 0:
            ...
            from src.helicon.helicon import convert_dataframe_file_path
        ...
        # copy parameters in the other star file
            ...
            for attr in "rlnImageName rlnMicrographName".split():
                if attr in data:
                    from src.helicon.helicon import get_relion_project_folder
    ...
    if args.path != "absolute":
        from src.helicon.helicon import get_relion_project_folder, convert_dataframe_file_path
